...
function Header() {
    ...
    const firstName = useSelector((state) => state.auth.user?.firstName || 'Tony');
                ...
                {isConnected ? (
                    <div className="connected flex items-center">
                        <Link to='/profile' className='flex items-center'>
                            <i className='dark:text-white fa-solid fa-2x fa-circle-user' />
                        ...
                        <Link to='/' onClick={logoutHandler} className='flex items-center ml-4'>
                            ...
                            <p className='dark:text-white ml-2'>Sign out</p>
                        </Link>
                    </div>
                ) : (
